...
## Tuần 6 — 04/05 → 10/05/2026 (cập nhật tới 09/05)

### Đã làm

- Mốc git tuần này:
  - 04/05: merge **PR #53–#61** — docs refactor, ingestion module, Telegram QR.
  - 05/05: merge **PR #62–#69** — daily limits, Notion integration, workspace updates.
  - 06/05: merge **PR #70–#71** — user timezone, hook fix, tutor settings.
  - 07/05: merge **PR #72–#74** — OpenAI docs, game sessions (Adventure Campaign), Memio Coach.
  - 08/05: merge **PR #75** — product improvement PRD.
  - 09/05: merge **PR #82–#83** — he thong XP (`total_xp`), UI Image Flashcard update.
  - 09/05: fix `scripts/log_hook.py` de ho tro tool **Antigravity**.
- Hoàn thiện hệ thống Gamification: XP earned từ study session và game được cộng vào `users.total_xp`.
- Memio Coach đã có thể trò chuyện, gợi ý hành động, và làm quiz ngay trong chat.
...
- Đảm bảo hệ thống XP hoạt động đồng bộ ở cả backend và frontend.

### AI tool đã dùng

- Antigravity: hỗ trợ rà soát codebase, fix hook, và cập nhật tài liệu kỹ thuật.

### Học được

- Việc có một "tư vấn viên" như Memio Coach giúp người học bớt ngợp khi đối diện với lượng tài liệu lớn.
- Gamification (XP, Level) thực sự tạo động lực rõ rệt cho việc ôn tập hằng ngày.

### Nếu làm lại, sẽ làm khác

- Nên thiết kế hệ thống XP tập trung hơn ngay từ đầu thay vì rải rác ở nhiều service.

### Kế hoạch tuần tới

- Triển khai Push Notification/Email cho các trigger quan trọng (exam urgency, streak risk).
